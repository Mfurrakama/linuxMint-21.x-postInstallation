...
## Removing unnecessary programs | Removendo programas desnecessarios ##
...
## Installing repositories | Instalando repositorios ##
...
## Installing updates, packages, apps and icons | Instalando atualizações, pacotes, apps e icones ##
